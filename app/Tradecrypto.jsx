                    ...
                    <View className='gap-[30px]'>
                        {Trade.map((data)=>(
                            <View className='flex-row items-center justify-between'>
                                ...
                                <TouchableOpacity>
                                 <Text className='border-[#FFAB10] border-[2px] p-[10px] text-center rounded-xl text-[#b6852a] w-[20vw] text-[17px]' onPress={Tradedeatails}>{data.button}</Text>
                                </TouchableOpacity>
                            </View>  
                        ))}
                    </View>   
