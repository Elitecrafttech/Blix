         ...
         <ScrollView className='w-[100%] py-[50px] bg-white' style={{width: windowWidth, height: windowHeight - 60}}>
          <View style={{padding: windowWidth * 0.05, gap: 100, height: dimensions.screen}}>
                <View className='gap-[15px]'>
                   <Text className='capitalize text-center font-semibold text-[25px] '>Data bundle</Text>
                    ...
                    <View className='gap-[70px] px-[10px] py-[20px]'>
                        ...
                        <View className=' gap-[15px]'>
                            ...
                            <View className='flex-row justify-between'>
                                ...
                                <Text style={{textTransform: 'uppercase', fontSize: 16}}>12GB - N10,000.00</Text>
                            </View>
                            <View className='flex-row justify-between'>
                ...
                <View className='gap-[20px]'>
                    ...
                    <Text className='text-center text-[red] font-medium text-[18px] capitalize'>report this transaction</Text>
                </View>
          </View>
        </ScrollView>
  );
