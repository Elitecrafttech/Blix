...
export default function Gotv() {
    ...
    const handletv = async() =>{
        ...
        const response = await fetch("https://instant-chain.onrender.com/api/v1/trades/gotv/due-date", {
            method: 'POST',
            headers: {
    ...
    const packages = async() =>{
        // alert("yes")
        try {
            const response = await fetch('https://instant-chain.onrender.com/api/v1/trades/gotv/packages',{
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const renewsub = async() =>{
        ...
        const response = await fetch("https://instant-chain.onrender.com/api/v1/trades/gotv/renew-subscription", {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${tk}`,
